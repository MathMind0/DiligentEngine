...
/// \file
/// Implementation of BottomLevelASMtlImpl for Metal ray tracing

#include "EngineMtlImplTraits.hpp"
#include "RenderDeviceMtlImpl.hpp"
#include "../../GraphicsEngine/include/BottomLevelASBase.hpp"
#include "../interface/BottomLevelASMtl.h"
...
/// Implementation of IBottomLevelAS for Metal backend.
///
/// Metal ray tracing uses MTLAccelerationStructure for bottom-level acceleration structures.
...
public:
    ...
    /// Creates a BLAS from an existing Metal acceleration structure resource.
    BottomLevelASMtlImpl(IReferenceCounters*          pRefCounters,
                         RenderDeviceMtlImpl*         pDevice,
                         const BottomLevelASDesc&     Desc,
